...
calculation.key.4.additional.text = {0} amount unpaid x 4% x number of days since day 31 ÷ 365
...
calculation.estimate.footerNote.billPayment = Paying part of your {0} bill will reduce further penalties.
calculation.estimate.footerNote.warning = This penalty will rise to £{0} (a further 2% of the unpaid {2}) if you do not make a {2} payment by {1}.
