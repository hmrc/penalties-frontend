...
summaryCard.appeal.B.L1 = Mae’r apêl wedi’i dderbyn
summaryCard.appeal.C.L1 = Mae canlyniad yr apêl wedi newid
summaryCard.appeal.C.L2 = Mae’r apêl wedi’i gwrthod gan y tribiwnlys treth
...
summaryCard.lpp.key3.value.ecn = Error Correction Notice of VAT for period {0} to {1}
summaryCard.lpp.key3.value.centralAssessment = Central Assessment of VAT for period {0} to {1}
summaryCard.lpp.key3.value.officersAssessment = Officer’s Assessment of VAT for period {0} to {1}
summaryCard.lpp.key3.value.additionalAssessment = Asesiad ychwanegol o TAW ar gyfer cyfnod {0} i {1}
summaryCard.lpp.key3.value.protectiveAssessment = Asesiad i ddiogelu o ran TAW ar gyfer cyfnod {0} i {1}
summaryCard.lpp.key3.value.poaReturnCharge = Rhandaliad taliad ar gyfrif ar gyfer cyfnod {0} i {1}
summaryCard.lpp.key3.value.aaReturnCharge = Balans cyfrifyddu blynyddol ar gyfer cyfnod {0} i {1}
