...
calculation.p.1.additional = The penalty is charged from 31 days after the payment due date, until the total is paid.
...
calculation.key.3.additional = Penalty rate
