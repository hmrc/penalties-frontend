...
agent.lsp.onThreshold.p2 = Mae hyn yn golygu bod yn rhaid i’ch cleient dalu cosb o £{0} bob tro mae’n cyflwyno Ffurflen TAW yn hwyr, hyd nes rydym yn tynnu ei bwyntiau.
lsp.onThreshold.p3 = Dyma’r dyddiad cynharaf y gellid tynnu’ch pwyntiau:
lsp.onThreshold.link = Y camau i’w cymryd i gael eich pwyntiau wedi’u tynnu erbyn {0}
agent.lsp.onThreshold.p3 = Dyma’r dyddiad cynharaf y gellid tynnu pwyntiau’ch cleient:
...
summaryCard.lpp.key2.value.manual = Cosb am dalu’n hwyr – mae’r manylion yn y llythyr a anfonom atoch
summaryCard.lpp.key3 = Tâl am fod yn hwyr
summaryCard.lpp.key3.value.vat = TAW ar gyfer cyfnod {0} i {1}
summaryCard.lpp.key3.value.centralAssessment = Asesiad canolog o TAW ar gyfer y cyfnod {0} i {1}
summaryCard.lpp.key3.value.ecn = Cywiriad gwall TAW ar gyfer {0} i {1}
summaryCard.lpp.key3.value.officersAssessment = Asesiad swyddog o TAW ar gyfer {0} i {1}
summaryCard.lpp.key3.value.additionalAssessment = Asesiad ychwanegol o TAW ar gyfer {0} i {1}
...
summaryCard.lpp.key3.value.vatOverpaymentCharge = Cywiriad TAW ar gyfer y cyfnod o {0} i {1}
...
summaryCard.details.summary = Pam na allwch apelio am y tro
summaryCard.details.text1 = Ni allwch apelio hyd nes bod y TAW wedi’i thalu.
summaryCard.details.text2 = Gall gymryd hyd at 5 diwrnod i’r taliad glirio ac ymddangos ar eich hanes taliadau. Os ydych eisoes wedi talu, cadwch lygad ar yr hanes taliadau i weld pryd y mae’r taliad yn clirio.
agent.summaryCard.details.text2 = Gall gymryd hyd at 5 diwrnod i’r taliad glirio ac ymddangos ar hanes taliadau eich cleient. Os yw’r cleient wedi talu yn barod, cadwch lygad ar yr hanes taliadau i weld pryd y mae’r taliad yn clirio.
summaryCard.details.text1.ca = Ni allwch apelio hyd nes eich bod yn cyflwyno’r Ffurflen TAW a thalu’ch TAW.
agent.summaryCard.details.text1.ca = Ni allwch apelio hyd nes bod y Ffurflen TAW wedi’i chyflwyno a bod eich cleient wedi talu’r TAW.
summaryCard.details.text2.ca = Os ydych yn credu nad oedd angen i chi gyflwyno Ffurflen TAW, apeliwch yn erbyn y gosb am gyflwyno’n hwyr ar gyfer y cyfnod TAW hwn yn lle.
agent.summaryCard.details.text2.ca = Os ydych yn credu nad oedd angen cyflwyno Ffurflen TAW, apeliwch yn erbyn y gosb am gyflwyno’n hwyr ar gyfer y cyfnod TAW hwn yn lle.
...
compliance.point.extension = Os byddwch yn colli dyddiad cau Ffurflen TAW, bydd yn rhaid i chi gyflwyno {0} yn rhagor o Ffurflenni TAW ar amser cyn y gallwn dynnu’ch pwyntiau.
agent.compliance.point.extension = Os bydd eich cleient yn colli dyddiad cau Ffurflen TAW, bydd angen iddo gyflwyno {0} yn rhagor o Ffurflenni TAW ar amser cyn y gallwn dynnu ei bwyntiau.
...
calculation.p.1.30.days.lpp1= Mae’r gosb hon yn gymwys os nad yw’r tâl am gywiriad TAW ar gyfer {0} i {1} wedi cael ei dalu am 30 diwrnod.
calculation.p.1.lpp2 = Mae’r gosb hon yn berthnasol o ddiwrnod 31 ymlaen, os oes TAW sydd heb ei thalu o hyd.
calculation.p.1.lpp2.vatCorrectionCharge = Mae’r gosb hon yn dechrau fod yn gymwys os oes tâl am gywiriad TAW heb ei dalu am 31 diwrnod.
...
calculation.lpp2 = (Cyfradd gosb o 4% x TAW sydd heb ei thalu) ÷ nifer y diwrnodau mewn blwyddyn
...
agent.calculation.p.3.estimates.lpp.ttpActive = Bydd cosbau’n dangos fel amcangyfrifon hyd nes y bydd eich cleient yn gwneud yr holl daliadau sy’n ddyledus o dan delerau’r cynllun talu.
...
calculation.p.2.estimates.lpp2.breathing.space = Bydd cosbau a llog yn ymddangos fel amcangyfrifon hyd nes y canlynol:
calculation.p.2.estimates.breathing.space.b1 = rydych yn talu’r costau cysylltiedig, ac
agent.calculation.p.2.estimates.breathing.space.b1 = mae’ch cleient yn talu’r costau cysylltiedig, ac
calculation.p.2.estimates.breathing.space.b1.ttp.active = rydych yn gwneud yr holl daliadau sy’n ddyledus o dan y cynllun talu, ac
agent.calculation.p.2.estimates.breathing.space.b1.ttp.active = mae’ch cleient yn gwneud yr holl daliadau sy’n ddyledus o dan y cynllun talu, ac
calculation.p.2.estimates.breathing.space.b2 = mae’r trefniant amser i gael eich gwynt atoch yn dod i ben
