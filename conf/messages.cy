...
calculation.p.2.additional.lpp2 = Penalties and interest will show as estimates if HMRC does not have enough information to calculate the final amounts.
calculation.p.2.additional.lpp1 = Penalties will show as estimates until:
calculation.p.2.additional.b1 = you pay the VAT bill, or
agent.calculation.p.2.additional.b1 = your client pays the VAT bill, or
calculation.p.2.additional.b2 = 30 days have passed since the VAT due date
calculation.returnLink = Return to VAT penalties and appeals
calculation.returnLink.estimated = Return to what you owe
agent.calculation.returnLink.estimated = Return to what your client owes
