...
calculation.key.1.additional = Amount to date (estimate)
...
calculation.key.2.paymentDetail = {0} amount unpaid on {1}
...
calculation.key.4.additional.text = Central assessment amount unpaid × 4% × number of days since day 31 ÷ 365
...
calculation.p.3.additional = This could be because:
calculation.bullet.1.additional = we have not received your VAT payment
calculation.bullet.2.additional = you have an unpaid penalty on your account
