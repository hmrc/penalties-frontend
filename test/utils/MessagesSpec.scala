...
class MessagesSpec extends SpecBase {
  ...
  private val excludedKeys = Seq("service.homePageUrl", "common.pageTitle", "calculation.key.3.additional.text", "calculation.value.amount", "summaryCard.appealLink.aria.label.lpp.vatPaid", "summaryCard.lpp.key3.value.vatOverpaymentCharge", "calculation.p.1.lpp2.vatCorrectionCharge", "calculation.p.1.30.days.lpp1")
