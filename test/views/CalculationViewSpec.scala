  ...
  "CalculationView" should {
    ...
    "if it is an additional penalty and the vat is not paid" must {
      def applyView(): HtmlFormat.Appendable = {
        calculationAdditionalPage.apply(7, vatDue = true, additionalPenaltyRate = "4",  "1 October 2022","31 December 2022", parentCharge = "VAT", amountToDate = BigDecimal(16.12))(implicitly, implicitly, implicitly, vatTraderUser)
      }
    ...
    "if it is an additional penalty and the vat is paid" must {
      def applyView(): HtmlFormat.Appendable = {
        calculationAdditionalPage.apply(7, vatDue = false, additionalPenaltyRate = "4",  "1 October 2022","31 December 2022", parentCharge = "VAT", amountToDate = 16.12)(implicitly, implicitly, implicitly, vatTraderUser)
      }
